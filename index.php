...
$title = "GronnFalk";
$description = "GronnFalk — an open-source, privacy-focused metasearch engine.";
...
$head .= tag("title", [], htmlspecialchars($title));
...
$githubLink =
    tag("a", [
        ...
        $githubIcon .
        tag("span", [], "Free and open source on GitHub")
    );


$footer =
    tag("footer", [], $githubLink);
